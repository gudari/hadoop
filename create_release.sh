...
curl -XPOST -H "Authorization:token $GITHUB_TOKEN" \
    ...
    --data-binary @hadoop-dist/target/hadoop-$VERSION.tar.gz https://uploads.github.com/repos/$GITHUB_ORGANIZATION/$GITHUB_REPO/releases/$id/assets?name=hadoop-$VERSION.tar.gz
